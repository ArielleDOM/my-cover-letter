...
export class UserEditor extends React.Component {
  ...
  render() {
    ...
    console.log('USER EDITOR PROPS', this.props)
    return <div>Test</div>
  }
}
...
const mapDispatch = dispatch => ({
  fetchSingleLetter: userId => dispatch(fetchSingleLetter(userId))
})
...
//   componentDidMount() {
//     // this.props.fetchSingleLetter(this.props.user.id)
//   }
...
//   const mapDispatch = dispatch => ({
//     fetchSingleLetter: (userId, letterId) => dispatch(fetchSingleLetter(userId,letterId))
//   })
